...
class ImplementationStubberTest {
    ...
    Stream<DynamicTest> testImplementationStubberWithNonParameterizedClass() {
        return stubberTester()
                ...
                .test(
                        Stubbers.implementation(CharSequence.class, String.class),
                        Stubbers.implementation(new TypeLiteral<CharSequence>() {}, new TypeLiteral<String>() {}),
                        Stubbers.implementation(CharSequence.class, new TypeLiteral<String>() {}),
                        Stubbers.implementation(new TypeLiteral<CharSequence>() {}, String.class)
                );
    }
    ...
    Stream<DynamicTest> testImplementationStubberWithParameterizedClass() {
        return stubberTester()
                ...
                .rejects(String.class)
                .rejects(Object.class)
                .test(Stubbers.implementation(new TypeLiteral<Collection<? extends CharSequence>>() {}, new TypeLiteral<List<String>>() {}));
    }

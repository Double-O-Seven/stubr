...
```groovy
implementation 'ch.leadrian.stubr:stubr-core:1.0.1'
```
...
For Gradle (Groovy DSL):
```groovy
implementation 'ch.leadrian.stubr:stubr-junit:1.0.1'
```
...
For Gradle (Groovy DSL):
```groovy
implementation 'ch.leadrian.stubr:stubr-mockito:1.0.1'
```
...
For Gradle (Groovy DSL):
```groovy
implementation 'ch.leadrian.stubr:stubr-kotlin:1.0.1'
```

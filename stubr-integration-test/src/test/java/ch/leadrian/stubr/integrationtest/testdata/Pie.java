...
public class Pie<T> {
    ...
    private static final EqualsAndHashCode<Pie> EQUALS_AND_HASH_CODE = equalsAndHashCodeBuilder(Pie.class)
            .compareAndHash(Pie::getIngredients)
            .build();

    private final List<T> ingredients;

    public Pie(List<T> ingredients) {
